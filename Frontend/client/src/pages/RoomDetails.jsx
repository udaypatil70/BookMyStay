    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2 animate-fade-in-up">
          ...
          >
            <svg
              className={`w-5 h-5 transition-colors duration-300 ${isFavourite ? "text-red-500 fill-red-500" : "text-gray-400"}`}
        ...
        <div className="flex items-center gap-1 mt-2 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="ml-2">{totalReviews > 0 ? `${totalReviews} Reviews` : "No Reviews Yet"}</p>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            {totalReviews > 0 && (
              <div className="flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-xl">
                <span className="text-2xl font-bold text-orange-600">{avgRating}</span>
          ...
          <div className="space-y-4 mb-8">
            {reviews.length === 0 ? (
              ...
              reviews.map((review) => (
                <div
                  key={review._id}
                  className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover-lift"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <p className="font-semibold text-gray-800 text-sm">{review.user?.username || "Guest"}</p>
              ...
              <form onSubmit={handleReviewSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <svg
                          className={`w-7 h-7 ${star <= reviewForm.rating ? "text-orange-400 fill-orange-400" : "text-gray-300"}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          strokeWidth="2"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm text-gray-700 outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all duration-300 resize-none"
                  />
                </div>
                <button
                  type="submit"
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <StarRating rating={avgRating || 4} />
                <p className="text-sm text-gray-500">{totalReviews > 0 ? `${totalReviews} reviews` : "No reviews yet"}</p>
              </div>
            </div>
          </div>
          <button
